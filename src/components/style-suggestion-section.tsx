...
import { Textarea } from "@/components/ui/textarea"; // Keep if you use it for reasoning display
...
interface StyleSuggestionSectionProps {
  ...
  onOutfitCreated: () => void; // Callback to refresh outfits list in parent
}
...
export function StyleSuggestionSection({ wardrobe, onOutfitCreated }: StyleSuggestionSectionProps) {
  ...
  const handleGenerateSuggestion = async () => {
    ...
    try {
      // Pass full wardrobe items, including IDs, to the AI flow
  ...
  const handleSaveSuggestedOutfit = async () => {
    ...
    startSavingTransition(async () => {
      try {
        ...
        setSuggestion(null); // Clear suggestion after saving
        onOutfitCreated(); // Notify parent to refresh outfit list
      } catch (error) {
